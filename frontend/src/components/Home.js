...
function Home({setShowLogin}) {
  ...
  return (
    <div className=' h-[96%] w-[100%] rounded-lg shadow-xl shadow-slate-500 lg:w-[81%] p-10 my-3 ml-4 mr-4 text-8xl text-center flex flex-col justify-center items-center'>
